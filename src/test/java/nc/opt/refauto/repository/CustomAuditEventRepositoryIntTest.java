package nc.opt.refauto.repository;

import nc.opt.refauto.RefautoApp;
import nc.opt.refauto.config.Constants;
import nc.opt.refauto.config.audit.AuditEventConverter;
import nc.opt.refauto.domain.PersistentAuditEvent;
...
import static nc.opt.refauto.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
