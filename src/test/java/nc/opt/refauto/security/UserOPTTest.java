...
public class UserOPTTest {
    ...
    public void test_setUser_verifyToString() {
        ...
        // Given
        List<GrantedAuthority> gas = Collections.singletonList(new SimpleGrantedAuthority("ROLE_1"));
        Map<String, List<String>> ressources = new HashMap<>();
        ressources.put("ROLE_1", Collections.singletonList("RES_1"));
    ...
    public void test_equals_verifyEquals() {
        ...
        List<GrantedAuthority> gas2 = Collections.singletonList(new SimpleGrantedAuthority("ROLE_1"));
        Map<String, List<String>> ressources2 = new HashMap<>();
        ressources2.put("ROLE_1", Collections.singletonList("RES_1"));
    ...
    public void test_hashcode_verify() {
        ...
        // When & Then
        assertThat(userOPT.hashCode()).isEqualTo(1028498747);
    }
}
